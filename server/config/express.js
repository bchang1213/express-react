...
//Assign the express middleware function to the 'app' keyword.
const app = express();

//if the config object from the environment variable setup in config.js is dev or prod, then run as such.
